...
async def get_event_by_id(eventquestion_id: int, current=Depends(require_permission("view_events"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
            cur.execute("""
...
async def get_eventquestions_by_event_id(event_id: int, current=Depends(require_permission("view_events"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
            cur.execute("""
...
async def create_eventquestiontype(req_data: AddEventQuestionType, current=Depends(require_permission("manage_event_questions"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
...
async def get_all_eventquestiontypes(current=Depends(require_permission("view_events"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
...
async def get_eventquestiontype_by_id(eventquestiontype_id: int, current=Depends(require_permission("view_events"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
            cur.execute(
...
async def update_eventquestiontype(req_data: UpdateEventQuestionType, current=Depends(require_permission("manage_event_questions"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
...
async def delete_eventquestiontype(eventquestiontype_id: int, current=Depends(require_permission("manage_event_questions"))):
    try:
        con = getConnect()
        with con.cursor() as cur:
